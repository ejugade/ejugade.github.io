...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Hi I'm Esha Jugade
            ...
            <h3 className="home__subtitle">SWE & AI/ML Developer</h3>
            <p className="home__description">
                I'm interested in designing and developing highly optimized solutions for complex real-world challenges in the space of SWE, AI/ML and Data Engineering. 
            </p>
